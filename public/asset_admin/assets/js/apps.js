...
Website: http://www.seantheme.com/color-admin-v2.0/admin/html/
    ...
    change by HuiwenDuan @2017/04/03
    1:修改了确认弹窗的确认语句
*/
...
var handleResetLocalStorage = function() {
    ...
    $(document).on('click', '[data-click=reset-local-storage]', function(e) {
        ...
        '                <h4 class="modal-title"><i class="fa fa-refresh m-r-5"></i> 重新设置本地存储确认框</h4>'+
        '            </div>'+
        '            <div class="modal-body">'+
        '                <div class="alert alert-info m-b-0">您想要重新设置本地存储的窗体样式么？</div>'+
        '            </div>'+
        '            <div class="modal-footer">'+
        '                <a href="javascript:;" class="btn btn-sm btn-white" data-dismiss="modal"><i class="fa fa-close"></i> 否</a>'+
        '                <a href="javascript:;" class="btn btn-sm btn-inverse" data-click="confirm-reset-local-storage"><i class="fa fa-check"></i> 是</a>'+
        '            </div>'+
        '        </div>'+
        '    </div>'+
        '</div>';
