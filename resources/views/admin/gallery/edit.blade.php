...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="javascript:;">商品图片集列表</a></li>
            <li class="active">商品图片集信息</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">修改商品图片集 <small>商品图片集详情信息</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">商品ID为{{ $gallery['goods_id'] }}</h4>
                    </div>
                    @if(count($errors)>0)
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true"
                              action="{{ url('admin/gallery/'.$gallery['id']) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="sort"
                                           ...
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入排序号"
                                           value="{{ $gallery['sort'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
