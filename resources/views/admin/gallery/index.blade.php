...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">商品图片集列表</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">商品图片集列表 <small>商品图片集列表页面</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/gallery.list.js')}}"></script>
    <script>
        $(function(){
            @if (session()->has('flash_notification.gallery'))
                //通知信息
                $.gritter.add({
                    title: '操作消息！',
                    text: '{!! session('flash_notification.gallery') !!}'
                });
            @endif
