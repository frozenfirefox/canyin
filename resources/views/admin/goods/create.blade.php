...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">新增产品 <small>添加产品信息</small></h1>
        <!-- end page-header -->
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/goods') }}" method="POST">
                            ...
                            <input type="hidden" id="pic-ids-gallery" name="goods_pictures" value="" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control" type="text" name="goods_brief"
                                              ...
                                              data-parsley-required="true"
                                              data-parsley-required-message="请输入商品简介">{{ old('goods_brief') }}
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control" type="text" name="goods_desc"
                                              ...
                                              data-parsley-required="true"
                                              data-parsley-required-message="请输入商品详细说明">{{ old('goods_desc') }}
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
{{--商品缩略图--}}
    <script>
        /*如果这里需要一些其他的方法和属性  请自行查看文档*/
        var dropzone = new Dropzone('#picdropzone', {
            url: '/base/upload_file',
