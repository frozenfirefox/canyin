...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">修改自定义属性</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">修改自定义属性 <small>修改自定义属性</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ $goodsattr['goods_attr_value'] }}</h4>
                    </div>
                    @if(count($errors)>0)
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/goodsattr/'.$goodsattr['id']) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <input type="hidden" name="businesses_id" value="{{ $goodsattr['businesses_id'] }}" />
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        @foreach($classes as $value)
                                            <option value="{{ $value['id'] }}" @if($value['id'] == $goodsattr['classes_type']) selected="selected" @endif>{{ $value['name'] }}</option>
                                        @endforeach
                                    </select>
                                    <p id="attr_error"></p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="goods_attr_value"
                                           ...
                                           value="{{ $goodsattr['goods_attr_value'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
