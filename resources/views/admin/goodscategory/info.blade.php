                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>缩略名</td>
                                <td>{{ $goodscategory['short_name'] }}</td>
                            </tr>
                            <tr>
                                <td>分类图标</td>
                                <td>{{ $goodscategory['cate_img'] }}</td>
                            </tr>
                            <tr>
                                <td>父ID</td>
                            ...
                            <tr>
                                <td>创建时间</td>
                                <td>{{ $goodscategory['create_at'] }}</td>
                            </tr>
                            <tr>
                                <td>更新时间</td>
                                <td>{{ $goodscategory['update_at'] }}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
