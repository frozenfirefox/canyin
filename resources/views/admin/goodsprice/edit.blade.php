...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">{{ $goodsprice['goods_specification'] }} <small>{{ $goodsprice['goods_specification'] }}</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ $goodsprice['goods_specification'] }}</h4>
                    </div>
                    @if(count($errors)>0)
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/goodsprice/'.$goodsprice['id']) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <input type="hidden" name="goods_id" value="{{ $goodsprice['goods_id'] }}" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                   <label class="control-label text-left">{{ $goodsprice['goods_name'] }}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="goods_specification"
                                           ...
                                           value="{{ $goodsprice['goods_specification'] }}"/>
                                </div>
                            </div>
                            @if(isset($goodsattr))
                                @if(isset($goodsattr2))
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <select class="form-control selectpicker"
                                                                ...
                                                                data-parsley-required="true"
                                                                data-parsley-errors-container="#name_error_{{ $k }}"
                                                                data-parsley-required-message="请选择{{$val['name']}}"
                                                                name="name_{{$k}}">
                                                            <option value="">-- 请选择 --</option>
                                                            @foreach($v as $k1=>$v1)
                                                                <option value="{{ $v1['id'] }}"   @if($v1['id'] == $goods_attr_sql[$k]) selected="selected"@endif>{{$v1['goods_attr_value']}}</option>
                                                               @endforeach
                                                        </select>
                                                        <p id="name_error_{{ $k }}"></p>
                                                    </div>
                                                </div>
                                            @endif
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="settlement_price" type="text"
                                           ...
                                           value="{{ $goodsprice['settlement_price'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="red_rurn_integral"
                                           ...
                                           value="{{ $goodsprice['red_rurn_integral'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="yellow_discount"
                                           ...
                                           value="{{ $goodsprice['yellow_discount'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="yellow_return_integral"
                                           ...
                                           value="{{ $goodsprice['yellow_return_integral'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="blue_discount"
                                           ...
                                           value="{{ $goodsprice['blue_discount'] }}"/>
                                </div>
                            </div>
                            {{--图片上传--}}
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="description">商品缩略图 * :</label>
                                <div class="col-md-6 col-sm-6 wt-dropzone"   id="picdropzone"></div>
                            </div>
                            <div class="form-group">
