...
<head>
    <meta charset="utf-8" />
    <title>餐饮网-管理后台</title>
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
    <meta content="餐饮" name="description" />
    <meta content="HuiwenDuan email:577633413@163.com" name="author" />

    <!--网站图标-->
    <link rel="shortcut icon" href="{{ asset('asset_admin/assets/img/img/logo.ico') }}" type="image/x-icon" />
    <!--网站图标-->
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown navbar-user">
                    ...
                    <ul class="dropdown-menu animated fadeInLeft">
                        ...
                        <li><a href="javascript:;"><span class="badge badge-danger pull-right">2</span> 待处理</a></li>
