...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{ url('/admin/menus') }}">后台目录管理</a></li>
            <li class="active">添加目录</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">添加目录 <small>添加目录表单信息</small></h1>
        <!-- end page-header -->
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/menus') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="name"
                                           ...
                                           data-parsley-required-message="请输入菜单名称"
                                           value="{{ old('name') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="url"
                                           placeholder="菜单链接"
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入菜单链接" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="slug"
                                           placeholder="权限名称"
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入权限名称" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="sort">菜单排序 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="sort" placeholder="菜单排序" value="0"/>
                                </div>
                            </div>
                            <div class="form-group">
