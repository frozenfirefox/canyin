...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{ url('/admin/menus') }}">后台目录列表</a></li>
            <li class="active">后台目录管理</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">后台目录管理 <small>后台目录管理列表信息</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-hover" id="treeTable">
                            ...
                            <tr>
                                ...
                                <th style="width: 17%;">目录链接</th>
                                <th style="width: 17%;">目录权限</th>
