                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        @foreach($arr_msg_type as $k=>$v)
                                            <option value="{{ $k }}"
                                            @if($k == $message['msg_type']) selected="selected" @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                    <p id="msg_error"></p>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        @foreach($arr_status as $k=>$v)
                                            <option value="{{ $k }}"
                                            @if($k == $message['status']) selected="selected" @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                    <p id="status_error"></p>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        @foreach($arr_user as $k=>$v)
                                            <option value="{{ $k }}"
                                            @if($k == $message['user_id']) selected="selected" @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                    <p id="user_error"></p>
                                </div>
