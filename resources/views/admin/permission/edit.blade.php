...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            <li><a href="{{ url('permission') }}">首页</a></li>
            <li><a href="{{ url('admin/permission') }}">后台权限列表</a></li>
            <li class="active">修改后台权限</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">修改权限 <small>权限详情信息</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ $permission['display_name'] }}</h4>
                    </div>
                    @if(count($errors)>0)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="name"
                                           placeholder="权限"
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入权限标识"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="description"
                                           placeholder="权限描述"
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入权限描述"
