...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">商品分类 <small>产品分类页面</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body" id="pic">
                        @if(auth('admin')->user()->can('productcategory.add'))
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/productcategory.list.js')}}"></script>
    <script>
        $(function(){
