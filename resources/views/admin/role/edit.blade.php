...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">修改角色 <small>角色详情信息</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{ $data['role']['display_name'] }}</h4>
                    </div>
                    @if(count($errors)>0)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="name"
                                           ...
                                           data-parsley-required-message="请输入角色名称（英文）"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text"
                                           ...
                                           placeholder="名称"
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入角色名称（中文）"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text"
                                           ...
                                           placeholder="描述"
                                           data-parsley-required="true"
                                           data-parsley-required-message="请输入角色描述"
