...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">新增员工 <small>添加员工信息</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/staff') }}" method="POST">
                            {{ csrf_field() }}
                            <input type="hidden" name="businesses_id" value="{{ $bid }}" />
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="role">选择员工 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                            ...
                                            data-parsley-required-message="请选择员工"
                                            name="user_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control" type="text" name="description"
                                              ...
                                              data-parsley-required="true"
                                              data-parsley-required-message="请输入员工描述">{{ old('description') }}
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group">
