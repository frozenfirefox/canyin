...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">新增优惠劵 <small>添加优惠劵信息</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" name="reg_testdate" action="{{ url('admin/ticket') }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea class="form-control" type="text" name="ticket_desc"
                                              ...
                                              data-parsley-required="true"
                                              data-parsley-required-message="请输入使用说明">{{ old('ticket_desc') }}
                                    </textarea>
                                </div>
                            </div>
