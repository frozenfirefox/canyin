...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">优惠券列表 <small>优惠券表页面</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        @if(auth('admin')->user()->can('ticket.add'))
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/ticket.list.js')}}"></script>
    <script>
        $(function(){
            @if (session()->has('flash_notification.ticket'))
                //通知信息
                $.gritter.add({
                    title: '操作消息！',
                    text: '{!! session('flash_notification.ticket') !!}'
                });
            @endif
