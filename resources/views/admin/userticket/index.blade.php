...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="javascript:;">用户优惠卷列表</a></li>
            <li class="active">用户优惠卷列表</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">用户优惠卷列表 <small>用户优惠卷列表页面</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        @if(auth('admin')->user()->can('userticket.add'))
                        <a href="{{ url('admin/userticket/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/userticket.list.js')}}"></script>
    <script>
        $(function(){
            @if (session()->has('flash_notification.userticket'))
                //通知信息
                $.gritter.add({
                    title: '操作消息！',
                    text: '{!! session('flash_notification.userticket') !!}'
                });
            @endif
