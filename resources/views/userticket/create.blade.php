                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/message') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="title" placeholder="消息标题" data-parsley-length="[1,60]"  data-parsley-required="true" data-parsley-required-message="请输入消息标题" value="{{ old('title') }}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="context" placeholder="消息内容" data-parsley-length="[1,100]"  data-parsley-required="true" data-parsley-required-message="请输入消息内容" value="{{ old('context') }}"/>
                                </div>
                            </div>
