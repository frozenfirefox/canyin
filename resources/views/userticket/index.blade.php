...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">消息列表 <small>消息列表页面</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        @if(auth('admin')->user()->can('message.add'))
                        <a href="{{ url('admin/message/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/message.list.js')}}"></script>
    <script>
        $(function(){
